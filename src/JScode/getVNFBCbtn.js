const getbtn = document.getElementById("getvnfbtn");
const v = document.getElementById("vnfdetail");
var orchetratorabi =[
	{
		"anonymous": false,
		"inputs": [
...
async function get() {
    ...
    try {
       ...
       // window.alert(receipt);
        var VNFID= receipt[0];
        var contractadd= receipt[1];
        var created=receipt[5];
        var cpunb= receipt[2];
        var Mnb= receipt[3];
        var Snb= receipt[4];
        
        v.innerHTML =  "VNF ID: "+ VNFID;
        v.innerHTML +="<br>"+   " VNF SC Address: "+ contractadd+"," +  "  status: "+ created;
        v.innerHTML +="<br>"+  "CPU nb: "+ cpunb+","+  "  Memory (Mb): "+ Mnb+"," +  "  Storage (Gb): "+ Snb;
        console.log(receipt);
